...
export const aiGroundingRules = {
  // Rule 1: Source Bound
  sourceBound: {
    rule: "AI may only answer using information contained within SEND Reform Navigator's curated content.",
    enforcement: "No external knowledge may be introduced.",
  },

  // Rule 2: Respect Confidence Labels
  respectConfidence: {
    rule: "AI must preserve and surface the correct confidence category for all information.",
  ...
  uncertaintyHandling: {
    ...
    disagreement: "If multiple credible views exist, the AI must explain that disagreement exists.",
...
export const editorialRules = {
  ...
  guardrails: "All contributors and AI outputs must respect the same guardrails",
