  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="w-full border-2 border-solid border-primary/30 rounded-2xl p-4 hover:border-primary/60 hover:bg-primary/5 transition-all duration-200 group shadow-lg bg-card"
      >
