...
const journeySteps = [
  {
    ...
    label: "What we know right now",
    shortLabel: "Right now",
    description: "The factual baseline",
    colorClass: "journey-step-confirmed",
  },
  {
    path: "/state-of-send-2026/what-is-changing",
    label: "What is now in motion",
    shortLabel: "In motion",
    description: "Confirmed reforms underway",
    colorClass: "journey-step-confirmed",
  },
  {
    ...
    description: "Rights still in force",
    colorClass: "journey-step-confirmed",
  },
  {
    path: "/state-of-send-2026/what-is-being-discussed",
    label: "What is actively being shaped",
    shortLabel: "Being shaped",
    description: "Live policy and consultation",
    colorClass: "journey-step-discussed",
  },
  {
    path: "/state-of-send-2026/what-we-do-not-know",
    label: "What is genuinely unknown",
    shortLabel: "Unknown",
    description: "No published answers yet",
    colorClass: "journey-step-discussed",
  },
  {
    path: "/state-of-send-2026/what-the-leaks-are-saying",
    label: "What has been reported",
    shortLabel: "Reported",
    description: "Media coverage and basis",
    colorClass: "journey-step-unconfirmed",
  },
  {
    path: "/state-of-send-2026/what-the-leaks-do-not-mean",
    label: "What is often misunderstood",
    shortLabel: "Misunderstood",
    description: "Where fear runs ahead",
    colorClass: "journey-step-unconfirmed",
  },
  {
