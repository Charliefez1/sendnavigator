...
export function WordFromRich({ children }: WordFromRichProps) {
  return (
    <div className="content-section py-4">
      <div className="rounded-xl border-l-4 border-l-[hsl(var(--accent-violet))] bg-[hsl(var(--accent-violet-bg))] border border-[hsl(var(--accent-violet)/0.2)] p-4 sm:p-5 space-y-2">
