...
export function SourceCard({ name, url, description }: SourceCardProps) {
  ...
  return (
    <a
      ...
      className="group flex items-start gap-3 p-3 rounded-xl border border-border bg-card shadow-lg hover:border-primary/30 hover:shadow-xl transition-all duration-200"
    >
      {/* Logo / favicon */}
