  ...
  return (
    <Layout>
      ...
      <section className="content-section py-8 space-y-5">
        ...
        <LetterSection heading="The system was broken. The government knows it.">
        ...
        <LetterSection heading="The money is real. For now.">
        ...
        <LetterSection heading="The architecture has a serious hole.">
        ...
        <LetterSection heading="Neurodivergent children are almost invisible in this document.">
        ...
        <LetterSection heading="Nobody is connecting the dots.">
        ...
        <LetterSection heading="Then we gave children dopamine on demand.">
        ...
        <LetterSection heading="And then we blamed the parents.">
        ...
        <LetterSection heading="This is not only the system's problem. And it is not only the school's.">
        ...
        <LetterSection heading="The workforce problem is not solved.">
        ...
        <LetterSection heading="What I think parents should do right now.">
        ...
        <LetterSection heading="My honest verdict." defaultOpen>
...
/** Always-visible block for non-collapsible content (intro) */
function LetterBlock({ children }: { children: React.ReactNode }) {
  return (
...
/** Collapsible headed section with violet accent */
function LetterSection({
  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="border-l-4 border-l-[hsl(var(--accent-violet))] bg-card border border-border rounded-xl shadow-sm overflow-hidden">
        <CollapsibleTrigger asChild>
          <button
            className="w-full flex items-center justify-between gap-3 p-5 sm:p-6 text-left hover:bg-muted/40 transition-colors cursor-pointer"
            aria-expanded={open}
          >
        ...
        <CollapsibleContent>
          <div className="px-5 sm:px-6 pb-5 sm:pb-6 prose-calm space-y-3 text-sm leading-relaxed">
            {children}
          </div>
        </CollapsibleContent>
      </div>
