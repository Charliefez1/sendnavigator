    ...
    <Layout>
      ...
      <section className="content-section py-8 border-t border-border">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-2">Two navigation bars</h2>
      ...
      <section className="content-section py-8 border-t border-border">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-2">What the colours mean</h2>
            <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="content-section py-8 border-t border-border">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-2">How each page is structured</h2>
            <p className="text-muted-foreground leading-relaxed">
      ...
      <section className="content-section py-8 border-t border-border">
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold text-foreground mb-2">Helpful features</h2>
          </div>
        </div>
        ...
        <div className="space-y-4 ml-14">
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-medium text-foreground">Reassurance first</h3>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
