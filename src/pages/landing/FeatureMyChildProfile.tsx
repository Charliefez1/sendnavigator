...
const FeatureMyChildProfile = () => (
  <div className="min-h-screen bg-background">
    <SEOHead title="My Child: A Profile | SEND Navigator" description="Build a professional, structured profile about your child to share with schools and professionals." path="/feature/my-child-profile" />
