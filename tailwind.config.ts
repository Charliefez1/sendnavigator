  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'card': '0 1px 3px 0 hsl(220 25% 20% / 0.06), 0 4px 12px -2px hsl(220 25% 20% / 0.08)',
        'card-hover': '0 2px 6px 0 hsl(220 25% 20% / 0.08), 0 8px 24px -4px hsl(220 25% 20% / 0.12)',
        'elevated': '0 4px 16px -4px hsl(220 25% 20% / 0.10), 0 12px 40px -8px hsl(220 25% 20% / 0.12)',
      },
    },
  },
